...
mal067 <- read_csv(here("output/disease_rtss_dmso_M0.csv")) %>%
  filter(FDR <= fdr_cut,
...
pdf(here("output/figures/Fig6b.pdf"), width = 9, height = 9)
fig6b
dev.off()
png(here("output/figures/Fig6b.png"), width = 750, height = 750)
fig6b
dev.off()
