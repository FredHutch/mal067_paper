...
mal067 <- read_csv(here("output/disease_comp_dmso_M3.csv")) %>%
...
pdf(here("output/figures/comp_multistudy_m3_hm.pdf"), width = 12, height = 6)
comp_multistudy_hm
dev.off()
png(here("output/figures/comp_multistudy_m3_hm.png"), width = 1200, height = 600)
comp_multistudy_hm
dev.off()
