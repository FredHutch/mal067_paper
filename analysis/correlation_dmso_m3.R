...
m3_expr <- exprAll[,m3_dmso_rtss_cols]
...
write_csv(iavi_cors, here("output/m3_dmso_rtss_iavi_cors.csv"))
write_csv(cevac_cors, here("output/m3_dmso_rtss_cevac_cors.csv"))
write_csv(antibody_cors, here("output/m3_dmso_rtss_antibody_cors.csv"))
write_csv(cytokine_cors, here("output/m3_dmso_rtss_cytokine_cors.csv"))
write_csv(pfs_cors, here("output/m3_dmso_rtss_pfs_cors.csv"))
