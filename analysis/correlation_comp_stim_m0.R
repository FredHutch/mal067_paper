...
for (s in non_dmso_stims) {
  ...
  write_csv(iavi_cors, here(glue("output/m0_{s}_dmso_diff_comp_iavi_cors.csv")))
  write_csv(cevac_cors, here(glue("output/m0_{s}_dmso_diff_comp_cevac_cors.csv")))
  write_csv(antibody_cors, here(glue("output/m0_{s}_dmso_diff_comp_antibody_cors.csv")))
  write_csv(cytokine_cors, here(glue("output/m0_{s}_dmso_diff_comp_cytokine_cors.csv")))
}
